...
class HomeActivity : Activity() {
    ...
    private fun showHome() {
        ...
        content.addView(EditText(this).apply { hint = "Tìm món ăn..."; textSize = 14f; singleLine = true; setPadding(dp(14), 0, dp(14), 0); background = bg(Color.WHITE, 14) }, LinearLayout.LayoutParams(-1, dp(46)).apply { bottomMargin = dp(10) })
