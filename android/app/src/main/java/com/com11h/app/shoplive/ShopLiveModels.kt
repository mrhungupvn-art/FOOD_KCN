...
/** Data models for COM11 SHOP LIVE V1. Keep models independent from Android UI. */
...
data class LiveRoom(val id: Long, val shopId: Long, val shopName: String, val title: String, val coverUrl: String? = null, val streamUrl: String? = null, val status: String = "live", val viewerCount: Int = 0, val pinnedProductId: Long? = null)
